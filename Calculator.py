...
class Application(Frame):
    ...
    def create_widgets(self):
        ...
        # Clear Button
        self.RestButton = Button(self, bg="#00802b", bd=12,
                                  text="AC", font=("Helvetica", 20, "bold"), width=28, padx=7,
                                  command=self.ClearDisplay)
        self.RestButton.grid(row=1, columnspan=4, sticky=W)
...
calculator.title("Calculator By: Ali Samir")
